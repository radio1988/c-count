...
num_images = len(image_arrays)  # typically 4
for i in range(num_images):
    ...
    print("Searching blobs for area", i)
    ...
    image_equ = block_equalize(image, block_height=config['block_height'], 
    ...
    np.save('blob_locs.npy', blob_locs)
    print("blob_locs", blob_locs[1:3])
